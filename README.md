...
4. Download your project from this link `https://github.com/lokeshc915/cqrs-example`
...
1. Download your project from this link `https://github.com/lokeshc915/cqrs-example`
...
```
    ...
    -> db.eventStore.find({})
```
7. Show data from both mysql by following all these commands shown below
```
